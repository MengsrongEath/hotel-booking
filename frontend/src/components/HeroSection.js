    ...
    <section className="relative h-screen bg-gradient-to-b from-blue-400 to-blue-600 overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-center h-full pt-20">
        ...
        <div className="absolute bottom-20 left-1/2 transform -translate-x-1/2 w-full max-w-4xl px-4">
          <div className="bg-white/95 backdrop-blur-md rounded-3xl p-8 shadow-2xl border border-white/20 animate-slide-up" style={{ animationDelay: '0.6s' }}>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-center">
              ...
              >
                ...
                <div>
                  ...
                  <div className="font-semibold text-gray-800">25 April 2025</div>
                </div>
              </div>
              ...
              >
                ...
                <div>
                  ...
                  <div className="font-semibold text-gray-800">1 Room 3 Guest</div>
                </div>
              </div>
              ...
              >
                ...
                <div>
                  ...
                  <div className="font-semibold text-gray-800">Sunset</div>
                </div>
              </div>

              {/* Search Button */}
              <div className="md:col-span-4 flex justify-center mt-6">
                <button className="bg-gradient-to-r from-teal-600 to-teal-700 text-white p-4 rounded-xl hover:from-teal-700 hover:to-teal-800 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center space-x-2">
                  <span className="font-semibold">Search Availability</span>
